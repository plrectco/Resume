...
\section{Experience}
  \resumeSubHeadingListStart
    ...
    \resumeItemListStart 
        \resumeItem{}{Developed MapReduce jobs in Go to process billion-scale user profiles and performed PetaByte-scale I/O with replicated and sharded storage.}
        \resumeItem{}{Designed user data profile analyzing pipelines in C++ that fix 75\% missing traffic tracking.}
