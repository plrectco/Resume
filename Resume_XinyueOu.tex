...
\section{Experience}
  \resumeSubHeadingListStart
    ...
    {Senior Software Engineer @ Youtube Ads Infrastructure}{May 2023 -- Now}{Software Engineer @ Youtube Ads Infrastructure}{May 2019 -- May 2023}
    \resumeItemListStart 
        \resumeItem{}{Led the design and implementation for Youtube Ads build pipeline that handles 100k+ messages/second and delivers PB level data daily.}
        \resumeItem{}{Devised an end to end dataset serving framework for Youtube Ads that automatically handle data canary, rollback and sharding, reducing the friction of dataset onboarding and improving the robustness of the system.}
        \resumeItem{}{Conducted multiple optimization iterations that  reduced the system's overall latency by 90\% and saved resource cost by 50\%.}
        \resumeItem{}{Boosted Server efficiency by rebalancing processing between serving and build pipelines. Achieved 70\% reduction of data loading time.}
        \resumeItem{}{Designed and implemented emergency handling and production health maintenance procedures. Led and conducted release improvement which cut down release time by 50\%.}
        \resumeItem{}{Established E2E testing and regression testing framework for the Youtube Ads serving and build pipelines. }
    \resumeItemListEnd
    ...
    \resumeSubheading
      ...
      \resumeItemListStart
        \resumeItem{}
          {Built and maintained the company’s official website, which is a responsive website that is optimized for both desktop and mobile devices. }
        \resumeItem{}
