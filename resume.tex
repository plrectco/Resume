...
\section{Education}
  \resumeSubHeadingListStart
    \resumeSubheading
      ...
      {Master of Science in Computer Science;  GPA: 3.80}{Sept 2017 -- Mar 2019}
      \resumeItemListStart
        \resumeItem{Courses}{Operating System, Database, Graduate Network, Neural Networks, Parallel Computing} 
      \resumeItemListEnd
    \resumeSubheading
      {Shanghai Jiao Tong University}{Shanghai, China}
      {Bachelor of Science in Electrical and Computer Engineering;  GPA: 3.89}{Sept 2013 -- Aug 2017}
...
\section{Experience}
  \resumeSubHeadingListStart
    ...
    \resumeItemListStart 
        \resumeItem{}{Developed MapReduce jobs in Go to process billion-scale user profile and performed PetaByte-scale I/O with replicated and sharded storage.}
        \resumeItem{}{Design user data profile analyzing pipelines in C++ that fix 75\% missing traffic tracking.}
        \resumeItem{}{Deploy 10+ jobs through large-scale cluster management tools and executed phased rollout and A/B testing.}
    ...
    \resumeProjectHeading
       {Tessaract: Triton Dropbox Service (Team Leader) - Java, gRPC}{May 2018 -- June 2018}
        \resumeItemListStart
            ...
            \resumeSimpleItem{Designed a achitecture that separates storage server and client-handling server.}
...
\section{Side Projects}
  \resumeSubHeadingListStart
    ...
    \resumeSimpleProjectHeading
       {TClassCal: UCSD Class Schedule Calendar Generator - Javascript}{Feb 2018} 
